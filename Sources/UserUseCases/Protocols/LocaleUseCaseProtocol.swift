...
public protocol LocaleUseCaseProtocol: UseCaseProtocol {
    ...
    func getSingleDTO(from model: LocaleModel, localization: @escaping @Sendable (String) -> String) async throws -> LocaleDTO
    func getManyDTOs(from models: [LocaleModel], localization: @escaping @Sendable (String) -> String) async throws -> LocalesDTO
